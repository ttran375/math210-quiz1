...
The first quartile ($Q_1$) is the median of the first half of the data, the 4th value of the first 7 value: 23

### B) Third quartile

The third quartile ($Q_3$) is the median of the last half of the data, the 4th value of the last 7 value: 40
